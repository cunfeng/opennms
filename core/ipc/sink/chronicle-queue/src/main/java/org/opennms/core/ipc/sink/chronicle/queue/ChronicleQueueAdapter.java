...
public class ChronicleQueueAdapter {
    ...
    public void createAppenderForModule(String moduleName) {
    ...
    public void createTailerForModule(String moduleName, QueueDispatcher dispatcher) {
        ...
        ChronicleQueue readQueue = SingleChronicleQueueBuilder.binary(queuePath).rollCycle(rollCycle)
